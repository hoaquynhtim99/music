...
if (!nv_function_exists('nv_block_detail_suggested_songs')) {
     ...
     * @return
     */
    function nv_block_config_detail_suggested_songs($module, $data_block, $lang_block)
    {
     ...
     * @return
     */
    function nv_block_config_detail_suggested_songs_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = [];
        $return['error'] = [];
    ...
    function nv_block_detail_suggested_songs($block_config)
    {
        ...
        if (empty($block_config['showtypesinger']) and empty($block_config['showtypeauthor'])) {
            ...
            $db->sqlreset()->select('song_id')->from(NV_MOD_TABLE . "_songs_random");
