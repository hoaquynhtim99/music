...
if( $id )
{
	$sqla = "SELECT id, title FROM `" . NV_PREFIXLANG . "_" . $module_data . "_category` WHERE id = ".$id."";
...
{ 
	...
	{ 
		$query = "INSERT INTO `" . NV_PREFIXLANG . "_" . $module_data . "_category` (`id`, `title`) VALUES ( NULL, " . $db->dbescape( $title ) . ")"; 
...
{
	$link = "index.php?" . NV_NAME_VARIABLE . "=" . $module_name."&" . NV_OP_VARIABLE . "=addsong&theloai=". $key ;
	$contents.="
	<tr>
		<td style=\"text-align:center;background: #eee;\">". $key ."</td>
		<td style=\"background: #eee;\">". $data ."</td>
		<td style=\"text-align:center;background: #eee;\">		
		<a href=\"index.php?" . NV_NAME_VARIABLE . "=" . $module_name . "&" . NV_OP_VARIABLE . "=category&id=" . $key . "\">". $lang_module['edit'] ."</a>
		<span class=\"add_icon\">
		<a href=\"".$link."\">". $lang_module['song_add'] ."</a>
		&nbsp;&nbsp;
		</span>
		</td> 
	</td>";
