    ...
    <div class="col-xs-24 col-sm-12 col-md-12 col-lg-12 ms-main-list-song-item">
        <article class="clearfix">
            ...
            <div class="ms-main-list-song-action">
                <ul>
                    <li><a href="#" title="{LANG.add_song_tolikelist}" class="song-hidden-inline" data-toggle="mscallpop" data-mode="addsongtolist" data-code="{ROW.song_code}" data-tokend="{ROW.tokend}" data-redirect="{ROW.redirect}"><i class="fa fa-plus" aria-hidden="true"></i></a></li>
