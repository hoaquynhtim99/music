...
<ul class="ms-list-song">
    ...
    <li>
        <div class="ms-list-song-action">
            <ul>
                <li><a rel="nofollow" href="#" title="{LANG.add_song_tolikelist}" data-toggle="mscallpop" data-mode="addsongtolist" data-code="{ROW.song_code}" data-tokend="{ROW.tokend}"><i class="fa fa-plus" aria-hidden="true"></i></a></li>
