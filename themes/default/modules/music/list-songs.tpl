    ...
    <li>
        <div class="ms-list-song-action">
            <ul>
                ...
                <li><a rel="nofollow" href="#" title="{LANG.download_this_song}" data-toggle="mscallpop" data-code="{ROW.song_code}" data-tokend="{ROW.tokend}"><i class="fa fa-download" aria-hidden="true"></i></a></li>
