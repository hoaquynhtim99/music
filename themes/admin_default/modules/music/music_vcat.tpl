	...
	<table class="tab1">
		...
		<thead>
			<tr>
				...
				<td style="width:100px" class="center">{LANG.siteinfo_numvideo}</td>
		...
		<tbody{ROW.class}>
			<tr>
				<td>
                    <select class="music-input" name="weight" id="weight{ROW.id}" onchange="nv_change_vcat_weight({ROW.id});">
                        <!-- BEGIN: weight -->
				...
				<td class="center">{ROW.numvideo}</td>
				<td class="center">
