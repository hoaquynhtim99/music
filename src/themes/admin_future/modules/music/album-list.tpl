        ...
        <div class="table-responsive-lg table-card">
            <table class="table ms-table ms-table-list-with-action-bottom table-sticky mb-0 mt-1">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <input class="ms-check-in-list form-check-input" type="checkbox" onclick="nv_UncheckAll(this.form, 'idcheck[]', 'check_all[]', this.checked);" value="{ROW.album_id}" name="idcheck[]" />
                        </td>
                        <td>
                        ...
                        <td>
                            <button data-toggle="mscallpop" type="button" class="btn btn-secondary btn-sm ms-btn-in-list" data-type="action" data-op="{OP}" data-id="{ROW.album_id}" data-name="{ROW.album_name}" data-options="{ACTION_STATUS}" data-langs="{LANG_STATUS}">
                                <span class="text" data-text="{ROW.state}">{ROW.state}</span>
                                <span class="caret"></span>
                            </button>
                        </td>
                        <td class="text-end">
                            <button data-toggle="mscallpop" type="button" class="btn btn-secondary btn-sm ms-btn-in-list" data-type="action" data-op="{OP}" data-id="{ROW.album_id}" data-name="{ROW.album_name}" data-options="edit|delete" data-langs="{GLANG.edit}|{GLANG.delete}" data-urledit="{ROW.url_edit}">
