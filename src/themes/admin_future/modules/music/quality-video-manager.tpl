                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <ul class="list-inline mb-0">
                                <!-- BEGIN: online_supported --><li class="list-inline-item"><span class="text-muted"><i title="{LANG.qvd_online_supported}" class="fa-solid fa-microphone"></i></span></li><!-- END: online_supported -->
                                <!-- BEGIN: online_notsupported --><li class="list-inline-item"><span class="text-muted"><i title="{LANG.qvd_online_notsupported}" class="fa-solid fa-microphone-slash"></i></span></li><!-- END: online_notsupported -->
                                <!-- BEGIN: is_default --><li class="list-inline-item"><span class="text-muted"><i title="{LANG.qvd_is_default}" class="fa-solid fa-circle-check"></i></span></li><!-- END: is_default -->
                                <!-- BEGIN: no_default --><li class="list-inline-item"><span class="text-muted"><i title="{LANG.qvd_no_default}" class="fa-solid fa-circle"></i></span></li><!-- END: no_default -->
                            </ul>
                        </td>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="fa-solid fa-pencil"></i> <span class="tit" data-msgadd="{LANG.qvd_add}" data-msgedit="{LANG.qvd_edit}"></span></h4>
