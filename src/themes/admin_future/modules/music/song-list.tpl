        ...
        <table class="table ms-table ms-table-list-with-action-bottom table-sticky">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button data-toggle="mscallpop" type="button" class="btn btn-secondary btn-sm ms-btn-in-list" data-type="action" data-op="{OP}" data-id="{ROW.song_id}" data-name="{ROW.song_name}" data-options="{ACTION_STATUS}" data-langs="{LANG_STATUS}">
