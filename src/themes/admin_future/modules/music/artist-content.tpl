    ...
    <div class="form-element">
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <label for="resource_avatar" class="col-form-label text-sm-end col-sm-4">{LANG.resource_avatar} <a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-title="{LANG.resource_avatar_artist_note}"><i class="fa-solid fa-circle-info"></i></a>:</label>
                    <div class="col-sm-8 col-md-5 col-lg-4">
                ...
                <div class="row mb-3">
                    <label for="resource_cover" class="col-form-label text-sm-end col-sm-4">{LANG.resource_cover} <a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-title="{LANG.resource_cover_artist_note}"><i class="fa-solid fa-circle-info"></i></a>:</label>
                    <div class="col-sm-8 col-md-5 col-lg-4">
                        <div class="input-group">
        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="row mb-3">
                    <label for="artist_name" class="col-form-label text-sm-end col-sm-4"><i class="fa-solid fa-asterisk"></i> {LANG.artist_name1}:</label>
                    <div class="col-sm-8 col-md-5 col-lg-4">
