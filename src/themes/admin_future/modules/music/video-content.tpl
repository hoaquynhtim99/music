...
<form id="msAjForm" method="post" action="{FORM_ACTION}" autocomplete="off" data-toggle="validate" data-type="ajax">
    ...
    <div class="form-element">
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8 col-md-5 col-lg-4">
                        <button tabindex="-1" type="button" class="btn btn-success float-start" data-toggle="modalPickSongs" data-multiple="false" data-title="{LANG.select_song}" data-list="#PickedSong" data-inputname="song_id">{LANG.select}</button>
                        <ul class="ms-content-picked-lists" id="PickedSong">
                            <!-- BEGIN: song -->
                            <li>
                                <input type="hidden" name="song_id" value="{SONG.song_id}">
                                <a class="delitem" href="#" data-toggle="delPickedSong"><i class="fa-solid fa-circle-xmark" aria-hidden="true"></i></a>
                ...
                <div class="row mb-3">
                    <label for="resource_avatar" class="col-form-label text-sm-end col-sm-4">{LANG.resource_avatar} <a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-title="{LANG.resource_video_note}"><i class="fa-solid fa-circle-info"></i></a>:</label>
                    <div class="col-sm-8 col-md-5 col-lg-4">
        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="row mb-3">
                    <label for="video_name" class="col-form-label text-sm-end col-sm-4"><i class="fa-solid fa-asterisk"></i> {LANG.video_name}:</label>
                    <div class="col-sm-8 col-md-5 col-lg-4">
        ...
        <h5><i class="fa-solid fa-file-video" aria-hidden="true"></i> {LANG.video_files}:</h5>
        <div class="card mb-3">
            <div class="card-body">
                <!-- BEGIN: mvquality -->
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8 col-md-5 col-lg-4">
                        <div class="input-group">
                            ...
                            <button class="btn btn-success" type="button" data-toggle="selectfile" data-target="resource_path_{MVQUALITY.quality_id}" data-type="file" data-path="{RESOURCE_DATA_PATH}" data-currentpath="{RESOURCE_DATA_CURRPATH}">{GLANG.browse_file}</button>
                        </div>
                    </div>
                </div>
                <!-- END: mvquality -->
                <div class="row mb-3">
                    <label for="resource_yt" class="col-form-label text-sm-end col-sm-4">{LANG.video_yt_link} <a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-title="{LANG.video_yt_link_help}"><i class="fa-solid fa-circle-info"></i></a>:</label>
                    <div class="col-sm-8 col-md-5 col-lg-4">
