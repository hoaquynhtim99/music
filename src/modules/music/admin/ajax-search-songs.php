...
$array_search['song_id_selected'] = Utils::arrayIntFromStrList($nv_Request->get_title('song_id_selected', 'post,get', '')); // Các bài hát đã chọn
...
if ($array_search['submit']) {
    ...
    // Loại trừ đi các bài hát đã chọn
    if (!empty($array_search['song_id_selected'])) {
        $base_url .= '&amp;song_id_selected=' . implode(',', $array_search['song_id_selected']);
    }
