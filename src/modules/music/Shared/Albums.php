...
use NukeViet\Module\music\Album\DataFields;
...
class Albums implements ITypeShare
{
    ...
    public static function creatUniqueCode()
    {
        ...
        while (true) {
            $code = strtolower(Utils::genCode(Settings::ALBUM_CODE_LENGTH));
    ...
    {
        return Resources::getTablePrefix() . Settings::TABLE_SEPARATOR_CHARACTER . Settings::TABLE_ALBUM;
    }
}
