...
if (!nv_function_exists('nv_block_detail_suggested_albums')) {
     ...
     * @return
     */
    function nv_block_config_detail_suggested_albums($module, $data_block)
    {
        global $nv_Lang;
     ...
     * @return
     */
    function nv_block_config_detail_suggested_albums_submit($module)
    {
        global $nv_Request;
        $return = [];
        $return['error'] = [];
    ...
    function nv_block_detail_suggested_albums($block_config)
    {
        ...
        global $module_info, $db, $ms_detail_data, $nv_Lang;
